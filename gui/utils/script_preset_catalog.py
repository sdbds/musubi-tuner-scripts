...
PRESET_SOURCES: Dict[str, Dict[str, Dict[str, str]]] = {
    "cache": {
        ...
        "framepack": {"arch": "FramePack", "script": "2.3framepack_cache_latent_and_text_encoder.ps1"},
        "flux_kontext": {"arch": "FLUX Kontext", "script": "2.4flux_kontext_cache_latent_and_text_encoder.ps1"},
        "qwen_image": {"arch": "Qwen Image", "script": "2.5、qwen_image_cache_latent_and_text_encoder.ps1"},
        "hv_1_5": {"arch": "HV 1.5", "script": "2.6hv_1_5_cache_latent_and_text_encoder.ps1"},
        "long_cat": {"arch": "Long-CAT", "script": "2.7long_cat_cache_latent_and_text_encoder.ps1"},
    ...
    "train": {
        ...
        "framepack": {"arch": "FramePack", "script": "3.3framepack_train_lora.ps1"},
        "flux_kontext": {"arch": "FLUX Kontext", "script": "3.4flux_kontext_train_lora.ps1"},
        "qwen_image": {"arch": "Qwen Image", "script": "3.5qwen_image_train_lora.ps1"},
        "hv_1_5": {"arch": "HV 1.5", "script": "3.7hv_1_5_train_lora.ps1"},
        "long_cat": {"arch": "Long-CAT", "script": "3.6long_cat_train_lora.ps1"},
    ...
    "generate": {
        ...
        "framepack": {"arch": "FramePack", "script": "5.3famepack_generate.ps1"},
        "flux_kontext": {"arch": "FLUX Kontext", "script": "5.4flux_kontext_generate.ps1"},
        "qwen_image": {"arch": "Qwen Image", "script": "5.5qwen_image_generate.ps1"},
        "hv_1_5": {"arch": "HV 1.5", "script": "5.6hv_1_5_generate.ps1"},
        "long_cat": {"arch": "Long-CAT", "script": "5.7long_cat_generate.ps1"},
        "zimage": {"arch": "Z-Image", "script": "5.8zimage_generate.ps1"},
    },
}
...
KEY_MAPS: Dict[str, Dict[str, str]] = {
    "cache": {
        ...
        "dopsd_cache_teacher_outputs": "dopsd_cache_teacher_outputs",
        "dopsd_teacher_text_encoder": "dopsd_teacher_text_encoder_path",
        "dopsd_teacher_already_reweighted": "dopsd_teacher_already_reweighted",
        "dopsd_teacher_allow_raw_vlm": "dopsd_teacher_allow_raw_vlm",
        "dopsd_teacher_dtype": "dopsd_teacher_dtype",
    },
    "train": {
