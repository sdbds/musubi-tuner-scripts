...
# model_path
$dataset_config = "./toml/task02_qversion_flux2.toml"                               # path to dataset config .toml file | Task02 水墨Q版数据集
...
#optimizer
$optimizer_type = "Prodigy_adv"                                                   # Prodigy 自动优化器
...
$output_name = "flux2_klein9b_task02_qversion"                                     # output model name | Task02 水墨Q版
$save_every_n_epochs = "1"                                                      # save every n epochs | 每5轮保存一次
...
$sample_prompts = "./toml/task02_qversion_flux2_sample.txt"                         # prompt file路径 | Task02 水墨Q版
