...
#训练模式(HunyuanVideo_Lora、HunyuanVideo_db、Wan_Lora、FramePack_Lora)
...
if ($train_mode -ilike "HunyuanVideo*" -or $train_mode -ilike "FramePack*") {
...
python -m accelerate.commands.launch --num_cpu_threads_per_process=8 $launch_args "./musubi-tuner/$laungh_script.py" `
  ...
  --logging_dir="./logs" `
  $ext_args
Assert-NativeCommandSucceeded "Command failed: 3.3framepack_train_lora.ps1"
